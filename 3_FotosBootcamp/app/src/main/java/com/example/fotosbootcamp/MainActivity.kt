...
class MainActivity : AppCompatActivity() {
    ...
    companion object {
        private val PERMISSION_CODE_IMAGE_PICK = 9315
        private val IMAGE_PICK_CODE = 9874

        private val PERMISSION_CODE_CAMERA_CAPTURE = 8516
        private val OPEN_CAMERA_CODE = 8013
    }
    ...
    private fun openCamera() {
        ...
        values.put(MediaStore.Images.Media.DESCRIPTION, "Imagem tirada pela camera")
